/// Knoten einer `View`, welcher dessen Positionierung und Dimensionierung bestimmt.
///
/// Diese Klasse ist Teil des Layoutsystems,
/// um die Größe und Position einer `View` zu bestimmen.
/// Zu jeder `View`, die im Layoutsystem teilnimmt,
/// gibt es eine entsprechende Unterklasse von `JustifiableNode`.
///
class JustifiableNode {
    ...
    /// Bestimmt die minimale und maximale Göße, die diese Node einnehmen kann.
	func justifyBounds() {
